...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, }, "t", function() awful.spawn("kitty -e tmux") end,
        { description = "Launch tmux", group = "user" }),
    awful.key({ modkey }, "f", function() awful.spawn("firefox") end, { description = "Launch Firefox", group = "user" }),
    awful.key({ modkey }, "b", function() awful.spawn("kitty -e bluetuith") end,
        { description = "Launch Bluetooth TUI", group = "user" }),
